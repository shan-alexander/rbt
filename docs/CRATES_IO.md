...
| Package | Install / use |
|---------|----------------|
| [`rbt-datalake`](https://crates.io/crates/rbt-datalake) | `cargo install rbt-datalake` → binary **`rbt`** · dep `rbt-datalake = "0.3.8"` · `use rbt::…` |
...
Latest published: **0.3.8** (after release).
