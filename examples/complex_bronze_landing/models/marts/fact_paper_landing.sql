---
description: >
  one row per successful or failed unit in a bronze run (grain: unit_or_paper_id × report_date × run_id).
  Thin fact: SK FKs + row_status + author_count measure from gold transform.
lineage_stamp: true
